...
try:
    project_client = AIProjectClient.from_connection_string(
        ...
        conn_str="eastus.api.azureml.ms;46e5da92-f07b-4876-9e40-d7e3ced34a05;srepoc-ai-rg;srepoc-ai-foundary-prj1"
    )
...
agent_ids = ["asst_lVIkhjO3Tov0dOkocQyX0ZlA"]  # Replace with your actual agent ID
agents = []
...
user_message = "Calculate total price for external ssd."
