...
# -------------------------------------------------
# This strategy performs stratified sampling to ensure that the class distribution
# in the target column is preserved in both training and test sets.
class StratifiedTrainTestSplitStrategy(DataSplittingStrategy):
    def __init__(self, test_size=0.2, random_state=42):
        """
        Initializes the StratifiedTrainTestSplitStrategy with specific parameters.
