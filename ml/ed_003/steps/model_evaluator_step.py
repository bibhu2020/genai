...
from src.model_evaluator import ModelEvaluator, RegressionModelEvaluationStrategy, ClassificationModelEvaluationStrategy
...
def model_evaluator_step(
    ...
    if strategy == "regression":
        ...
        raise ValueError(f"Unknown strategy: {strategy}. Use 'regression' or 'classification'.")
    # evaluator = ModelEvaluator(strategy=RegressionModelEvaluationStrategy())
