# Uses of the Strategy Pattern for Data Inspection
# ---------------------------------------------------
# This module provides various strategies for inspecting data in a pandas DataFrame.
# It includes strategies for checking data types, summary statistics, and missing values analysis.
